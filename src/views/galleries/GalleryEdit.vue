  ...
  <div class="pb-16">
    ...
    <div class="grid grid-cols-1 gap-6 px-8 py-6 xl:grid-cols-[minmax(0,1fr)_360px]">
      ...
      <aside class="space-y-5 xl:sticky xl:top-[92px] xl:self-start">
        <!-- Zveřejnění -->
        <FormSection title="Zveřejnění" icon="eye" tag="gallery-published">
          <div class="space-y-3">
            <div class="flex items-center justify-between rounded-md bg-steel-50 px-3 py-2.5">
              ...
              <span class="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[11.5px] font-600" :class="[GALLERY_STATE_META[state].bg, GALLERY_STATE_META[state].text]">
                <span class="h-1.5 w-1.5 rounded-full" :class="GALLERY_STATE_META[state].dot" />
                {{ GALLERY_STATE_META[state].label }}
              </span>
            </div>
